...
<style type="text/css">
  ...
  <!-- Basic -->
  <title>SOLOarancini | Registrazione</title>
...
<body>
  ...
  <div id="container">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                ...
                <ul class="dropdown">
				  ...
				  <li><a class="active" href="registration_page.php">Registrati</a>
                  </li>
	...
	<?php if (!$_SESSION["login"]) {?> <div class="loginform" style="width: 30%; margin: 0 auto; margin-bottom: 3%; margin-top: 3%;">
		<form name="Registrazione" action="registration.php" method="post" accept-charset="utf-8" class="subscribe">
			<label for="firstname">Nome</label>
			<input id="firstname" type="text" name="nome" placeholder="Il tuo nome" required>
			<label for="lastname">Cognome</label>
			<input id="lastname" type="text" name="cognome" placeholder="Il tuo cognome" required>
			<label for="address">Indirizzo</label>
			<input id="address" type="text" name="indirizzo" placeholder="Il tuo indirizzo. Esempio: via giallissima n.2" required>
			<label for="city">Città</label></p>
			<input id="city" type="text" name="citta" placeholder="Il tuo indirizzo. Esempio: Catania"  required>
			<label for="email">Email</label>
			<input id="email" type="email" name="E-mail" placeholder="la tua mail. Esempio: example@mail.it" required>
			<label for="phone">Numero telefonico</label>
			<input id="phone" type="text" name="numero" placeholder="Il tuo numero telefonico" required>
			<label for="cap">CAP</label>
			<input id="cap" type="text" name="cap" placeholder="XXXXX" pattern="[0-9]{5}"required> 
			<label for="password">Password</label>
			<input type="password" name="password" placeholder="immetti la tua password" onchange="form.password2.pattern = this.value;"required>
			<label for="password">Riscrivi la tua password</label>
			<input type="password" name="password2" placeholder="immetti la tua password" required>
			<input name="registered" type="submit" value="Registrati">
		</form>
